...
public class AboutPage extends Stage {
	private static final String TITLE = "About",
			ABOUT_PAGE_FXML_LOCATION = "/ui/aboutPage/aboutPage.fxml";

	public AboutPage() {
		FXMLLoader loader = new FXMLLoader(getClass().getResource(ABOUT_PAGE_FXML_LOCATION));
		...
		((AboutPageController) loader.getController()).initialize(this);
