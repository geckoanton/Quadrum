...
public class SetCurrentFrameAction implements Action {
	private int currentFrame;

	public SetCurrentFrameAction(int currentFrame) {
		this.currentFrame = currentFrame;
	}
	@Override
	public void execute(Project project) {
		project.setCurrentFrame(currentFrame);
	}
}
